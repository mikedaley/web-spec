...
private:
    ...
    static bool load128K(ZXSpectrum& machine, const uint8_t* data, uint32_t size);
    ...
    static constexpr uint32_t SNA_128K_SIZE = 131103;   // 27 header + 49152 RAM + 4 extra + 5*16384 remaining banks

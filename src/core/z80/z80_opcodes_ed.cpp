...
void Z80::LDI(uint8_t)
{
    ...
    z80NoMreqContention(m_CPURegisters.reg_pairs.regDE, 1);
    z80NoMreqContention(m_CPURegisters.reg_pairs.regDE, 1);
...
void Z80::LDIR(uint8_t opcode)
{
    ...
    {
        z80NoMreqContention(m_CPURegisters.reg_pairs.regDE - 1, 1);
        z80NoMreqContention(m_CPURegisters.reg_pairs.regDE - 1, 1);
        z80NoMreqContention(m_CPURegisters.reg_pairs.regDE - 1, 1);
        z80NoMreqContention(m_CPURegisters.reg_pairs.regDE - 1, 1);
        z80NoMreqContention(m_CPURegisters.reg_pairs.regDE - 1, 1);
...
void Z80::CPIR(uint8_t opcode)
{
    ...
    {
        z80NoMreqContention(m_CPURegisters.reg_pairs.regHL - 1, 1);
        z80NoMreqContention(m_CPURegisters.reg_pairs.regHL - 1, 1);
        z80NoMreqContention(m_CPURegisters.reg_pairs.regHL - 1, 1);
        z80NoMreqContention(m_CPURegisters.reg_pairs.regHL - 1, 1);
        z80NoMreqContention(m_CPURegisters.reg_pairs.regHL - 1, 1);
...
void Z80::OTIR(uint8_t opcode)
{
    ...
    if (m_CPURegisters.regs.regB != 0)
    {
        z80NoMreqContention(m_CPURegisters.reg_pairs.regBC, 1);
        z80NoMreqContention(m_CPURegisters.reg_pairs.regBC, 1);
        z80NoMreqContention(m_CPURegisters.reg_pairs.regBC, 1);
        z80NoMreqContention(m_CPURegisters.reg_pairs.regBC, 1);
        z80NoMreqContention(m_CPURegisters.reg_pairs.regBC, 1);
